...
import co.kr.itforone.holoholic.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public int drawableArr[] = {
            ...
            R.drawable.main_icon02,
            R.drawable.main_icon03,
            R.drawable.main_icon04,
            R.drawable.main_icon05,
            R.drawable.main_icon06,
            R.drawable.main_icon07,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //유튜브 아이디 가져오기
        if(!Common.getPref(MainActivity.this,"youtubeId","").equals("")) {
            youtubeId = Common.getPref(MainActivity.this, "youtubeId", "");
        }
        Log.d("youtubeId",youtubeId+"1");
        //인스타그램 아이디 가져오기
        if(!Common.getPref(MainActivity.this,"instagramUrl","").equals("")) {
            instagramUrl = Common.getPref(MainActivity.this, "instagramUrl", "");
        }
        //소켓통신 연결시키기
        ...
        dataBiding.wheelImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(NetworkCheckReceiver.isNetwork==false){
                    ...
                    Log.d("ss_mb_id",Common.getPref(MainActivity.this, "ss_mb_id", "")+"1");
                    if (!Common.getPref(MainActivity.this, "ss_mb_id", "").equals("")) {
                        ...
                        try {
                            ...
                            obj.put("s_id", Common.getPref(MainActivity.this, "s_id", ""));
                            ...
                            if (selectedPosition == 2) {
                                ...
                                Snackbar.make(dataBiding.mainLayout,"Instagram is currently not available.", Snackbar.LENGTH_SHORT).show();
...
//                    filePathCallbackLollipop.onReceiveValue(null);
    ...
    class WebJavascriptEvent{
        ...
        public void saveUrl(String y,String i){
            try{
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Common.savePref(MainActivity.this,"youtubeId",y);
                        MainActivity.youtubeId=y;
                        Common.savePref(MainActivity.this,"instagramUrl",i);
                        MainActivity.instagramUrl=i;
                        dataBiding.drawerLayout.closeDrawer(dataBiding.drawerMenuLayout);
        ...
        public void setSignageDeviceId(){
            ...
            String signageId=Common.getPref(MainActivity.this,"SignageId","");
            AlertDialog.Builder builder=new AlertDialog.Builder(MainActivity.this);
            ...
            builder.setPositiveButton("Connect", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Common.savePref(MainActivity.this,"SignageId",signageEdit.getText().toString());
